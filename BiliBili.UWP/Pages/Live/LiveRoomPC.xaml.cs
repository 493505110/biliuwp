...
namespace BiliBili.UWP.Pages.Live
{
    ...
    public sealed partial class LiveRoomPC : Page
    {
        ...
        private void LoadSetting()
        {
            ...
            //弹幕大小
            danmu.DanmakuSizeZoom = SettingHelper.Get_NewLDMSize();
            ...
            //弹幕速度
            danmu.DanmakuDuration = Convert.ToInt32(SettingHelper.Get_NewLDMSpeed());

            danmu.DanmakuBold = SettingHelper.Get_BoldDanmu();
        ...
        private void slider_DanmuSpeed_ValueChanged(object sender, RangeBaseValueChangedEventArgs e)
        {
            ...
            danmu.DanmakuDuration = slider_DanmuSpeed.Value.ToInt32();
